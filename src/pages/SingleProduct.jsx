                    ...
                    <div className="col-6">
                      ...
                      <div className="border-bottom py-3">
                        <div className="d-flex gap-10 align-items-center my-2">
                          ...
                          <p className='product-data'>Tshirt</p></div>
                        <div className="d-flex gap-10 align-items-center my-2">
                          <h3 className='product-heading'>Brand :</h3>
                          <p className='product-data'>{singleProdState?.brand}</p></div>
                        <div className="d-flex gap-10 align-items-center my-2">
                          <h3 className='product-heading'>Category :</h3>
                          <p className='product-data'>{singleProdState?.category}</p></div>
                        <div className="d-flex gap-10 align-items-center my-2">
